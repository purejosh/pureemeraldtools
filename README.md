...
Get the latest download for your mod loader at [CurseForge](https://www.curseforge.com/minecraft/mc-mods/pure-emerald-tools-fabric-forge).

## Issues or Suggestions

Please open an issue in Github, and choose [Bug](https://github.com/purejosh/pureemeraldtools/issues) or [Suggestion](https://github.com/purejosh/pureemeraldtools/issues).
...
## License
[MIT-R-NR](https://github.com/purejosh/pureemeraldtools/blob/main/LICENSE.txt)

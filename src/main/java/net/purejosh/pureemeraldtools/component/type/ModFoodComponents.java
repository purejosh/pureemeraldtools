package net.purejosh.pureemeraldtools.component.type;
...
public class ModFoodComponents {
    ...
    public static final FoodComponent PURE_EMERALD_APPLE = new FoodComponent.Builder()
            .nutrition(4)
            .saturationModifier(1.2F)
            ...
            .statusEffect(new StatusEffectInstance(StatusEffects.HERO_OF_THE_VILLAGE, 48000, 5), 1.0F)
            .alwaysEdible()
            .build();

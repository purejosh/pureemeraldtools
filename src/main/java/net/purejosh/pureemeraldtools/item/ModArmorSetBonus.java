...
import net.purejosh.pureemeraldtools.entity.effect.ModStatusEffects;
...
public class ModArmorSetBonus extends ArmorItem {
    private static final Map<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>>())
                    .put(ModArmorMaterials.PURE_EMERALD,
                            List.of(new StatusEffectInstance(ModStatusEffects.POISON_WARDING, 10, 0, false, false)))
                    .put(ModArmorMaterials.PURE_EMERALD_NETHERITE,
                            List.of(new StatusEffectInstance(ModStatusEffects.POISON_WARDING, 10, 0, false, false)))
                    .build();
